...
try {
  ...
  Array.isArray(components.content) &&
    console.info(components.content[0].text.substring(0, 200) + '...');
  ...
  Array.isArray(componentDetail.content) &&
    console.info('组件详情获取成功，数据长度:', componentDetail.content[0].text.length);
  ...
  Array.isArray(componentExamples.content) &&
    console.info('组件示例获取成功，数据长度:', componentExamples.content[0].text.length);
  ...
  Array.isArray(componentExampleSource.content) &&
    console.info('组件示例源码获取成功，数据长度:', componentExampleSource.content[0].text.length);
