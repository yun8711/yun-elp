    ...
    props: [
      {
        name: 'elp-config',
        description:
          '[el-config-provider](https://element-plus.org/zh-CN/component/config-provider.html)',
        type: {
  ...
  'y-column-text': {
    ...
    props: [
      ...
      },
      {
        name: 'formatter',
        description:
          '自定义单元格文本格式化函数，作用同 el-table-column的 formatter，只是修改了参数顺序',
        type: {
          raw: 'function'
        },
        required: false,
  ...
  'y-dialog': {
    ...
    props: [
      ...
      },
      {
        name: 'before-close',
        description:
          '关闭前的回调，会暂停 Dialog 的关闭，回调函数内执行 done 参数方法的时候才会真正关闭对话框',
        type: {
  ...
  'y-drawer': {
    ...
    props: [
      ...
      },
      {
        name: 'before-close',
        description:
          '关闭前的回调，会暂停 Drawer 的关闭，回调函数内执行 done 参数方法的时候才会真正关闭对话框',
        type: {
          raw: '(done: DoneFn) => void'
        },
        required: false
  ...
  'y-pop': {
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        default:
          "{titel:'提示',placement:'bottom',width:226,popperClass: 'y-pop__popover',trigger: 'click'}"
      },
      {
        name: 'no-footer',
  ...
  'y-table': {
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        default:
          "{layout: 'prev, pager, next, sizes, jumper',background: true,pageSizes: [10, 20, 30, 40, 50, 100, 200],total: 0}"
      },
      {
      ...
      },
      {
        name: 'height',
        description:
          'table 的高度；默认为自动高度；如果 height 为 number 类型，单位为 px；如果 height 为 string 类型，则会设置为 Table 的 style.height 的值，Table 的高度会受控于外部样式',
        type: {
          raw: 'string | number'
        },
        required: false
      ...
      },
      {
        name: 'row-key',
        description:
          '行数据的 Key，优化 Table 的渲染；在使用reserve-selection或显示树形数据时，该属性必填。类型为 String 时，支持多层访问：user.info.id，但不支持 user.info[0].id，此种情况请使用函数',
        type: {
          raw: 'function | string'
        },
        required: false
      ...
      },
      {
        ...
        description:
          '设置 Table 当前的展开行，需要设置 row-key 属性才能使用，该属性为展开行的 keys 数组',
        type: {
          raw: 'array'
        },
        required: false
      ...
      },
      {
        ...
        description:
          '溢出 tooltip 的选项， 同[el-tooltip](https://element-plus.org/zh-CN/component/tooltip#attributes)',
        type: {
      ...
      },
      {
        name: 'show-overflow-tooltip',
        description:
          '是否隐藏额外内容并在单元格悬停时使用 Tooltip 显示它们。这将影响全部列的展示，参见[el-tooltip](https://element-plus.org/zh-CN/component/tooltip#attributes)',
        type: {
          raw: 'boolean | object'
        },
        required: false
    ...
    events: [
      ...
      },
      {
        name: 'expand-change',
        description:
          '当对某一行展开或者关闭的时候会触发该事件（展开行时，回调的第二个参数为 expandedRows；树形表格时第二参数为 expanded）',
        parameters: [
          {
  ...
  'y-text-tooltip': {
    ...
    props: [
      ...
      },
      {
        ...
        description:
          'Tooltip 可用的 positions 请查看[popper.js](https://popper.js.org/docs/v2/modifiers/flip/#fallbackplacements)',
        type: {
          raw: 'array'
        },
        required: false
