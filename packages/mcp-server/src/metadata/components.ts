...
export default {
  "y-app-wrap": {
    ...
    "props": [
      ...
      {
        "name": "tip-props",
        "description": "tooltip 配置属性，详见 [el-tooltip](https://element-plus.org/zh-CN/component/tooltip.html#attributes)",
        "type": {
          "raw": "Partial<ElTooltipProps>"
        },
        "required": false
      ...
      {
        "name": "pop-props",
        "description": "popover 配置属性，详见 [el-popover](https://element-plus.org/zh-CN/component/popover.html#attributes)",
        "type": {
  ...
  "y-cron-picker": {
    ...
    "description": "定时选择器",
    "detailedDescription": "基于 [`cron-parser^5.5.0`](https://www.npmjs.com/package/cron-parser) 封装的定时选择器组件，支持多种调度周期（分钟、小时、日、周、月、年）的配置，可以生成标准的 Cron 表达式，并提供执行时间的预览功能。\n注意：需要单独安装 `cron-parser`",
